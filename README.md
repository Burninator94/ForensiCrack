...
└── wordlists/    # Required wordlists (passphrases auto-downloaded)
...
This should create all runtime directories, install required tools via apt, build and install pkcrack from source (if needed), download the passphrases.txt wordlist automatically, and self-validate completion
...
4. pkcrack - Known plaintext attack tool for legacy Zip encryption ( https://github.com/keyunluo/pkcrack )
